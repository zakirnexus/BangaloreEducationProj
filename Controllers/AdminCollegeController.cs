    ...
    public class AdminCollegeController : Controller
    {
        ...
        public IActionResult Index(string search = "", int? cityId = null)
        {
            ...
            if (!string.IsNullOrEmpty(search))
                query = query.Where(c => c.InstituteName.Contains(search));
        ...
        public IActionResult Courses(int collegeId)
        {
            ...
            ViewBag.AllCourses = _context.Courses.Where(c => c.IsActive).ToList();
            return View(college);
        }

        [HttpPost]
        public IActionResult AddCourse(int instituteId, int courseId, string? specialization,
